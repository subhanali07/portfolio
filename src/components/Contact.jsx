...
const Contact = () => {
  ...
  return (
    <>
      <section id="contact" className=" min-h-fit lg:min-h-screen max-w-9xl px-6 lg:px-8 pt-4 pb-2 lg:py-8 leading-tight scroll-mt-28 ">
        ...
        <div className="w-md h-auto lg:w-200 bg-paper border-4 rounded-xl shadow-[6px_6px_0px_0px_#1a1a1a] 2xl:w-200 pb-4 ">
